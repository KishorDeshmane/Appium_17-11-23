package stepDefinitions.customer.home;
...
public class B0001_Home_page {
	...
	@Given("Verify that user is on the home page of the customer application")
	public void verify_that_user_is_on_the_home_page_of_the_customer_application() {
