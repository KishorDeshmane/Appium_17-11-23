package stepDefinitions.customer.bookings;
...
import com.pages.bookings.E0001_Booking_page_objects;
...
public class E0001_Booking_page {
	...
	E0001_Booking_page_objects bo = new E0001_Booking_page_objects(DriverFactory.getDriver());
	...
	@Given("Verify that user is on the bookings page of the customer application")
	public void verify_that_user_is_on_the_bookings_page_of_the_customer_application() {
		...
		hp.booking_page_button_is_clicked();
		boolean actual = bo.bookings_button_in_blue_is_displayed();
