package stepDefinitions.customer.packages;
...
import com.pages.packages.C0001_Package_page_objects;
import com.qa.factory.DriverFactory;

import io.cucumber.java.en.Given;
import stepDefinitions.customer.A0004_Verify_otp_page;

public class C0001_Package_page {
	...
	C0001_Package_page_objects pp = new C0001_Package_page_objects(DriverFactory.getDriver());
	...
	@Given("Verify that user is on the Packages page of the customer application")
	public void verify_that_user_is_on_the_Packages_page_of_the_customer_application() {
		...
		hp.packages_page_button_is_clicked();
		boolean actual = pp.packages_page_button_in_blue_is_displayed();
